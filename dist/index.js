...
(() => {
  ...
  // node_modules/.pnpm/three@0.165.0/node_modules/three/build/three.module.js
  var REVISION = "165";
  var CullFaceNone = 0;
  var CullFaceBack = 1;
  var CullFaceFront = 2;
...
void main() {
  ...
  // node_modules/.pnpm/@firecms+neat@0.2.2_three@0.165.0/node_modules/@firecms/neat/dist/index.es.js
  var g = 50;
  var _ = 80;
  var T = true;
  var C = 5;
  ...
  var X = class {
    ...
    constructor(e) {
      ...
      const S = () => {
        ...
        Math.floor(z * 10) % 5 === 0 && W(o), h.setClearColor(this._backgroundColor, this._backgroundAlpha), y.forEach((s) => {
          ...
          z += V.getDelta() * this._speed, s.material.uniforms.u_time.value = z, s.material.uniforms.u_resolution = { value: new Vector2(K, D) }, s.material.uniforms.u_color_pressure = { value: new Vector2(this._horizontalPressure, this._verticalPressure) }, s.material.uniforms.u_wave_frequency_x = { value: this._waveFrequencyX }, s.material.uniforms.u_wave_frequency_y = { value: this._waveFrequencyY }, s.material.uniforms.u_wave_amplitude = { value: this._waveAmplitude }, s.material.uniforms.u_plane_width = { value: g }, s.material.uniforms.u_plane_height = { value: _ }, s.material.uniforms.u_color_blending = { value: this._colorBlending }, s.material.uniforms.u_colors = { value: L }, s.material.uniforms.u_colors_count = { value: C }, s.material.uniforms.u_shadows = { value: this._shadows }, s.material.uniforms.u_highlights = { value: this._highlights }, s.material.uniforms.u_saturation = { value: this._saturation }, s.material.uniforms.u_brightness = { value: this._brightness }, s.material.wireframe = this._wireframe;
        ...
        this.sceneState.renderer.setSize(d, y, false), F(this.sceneState.camera, d, y);
      };
    ...
    _initScene(e) {
      const o = this._ref.width, i = this._ref.height, n = new WebGLRenderer({
        alpha: true,
        canvas: this._ref
      });
      n.setClearColor(16711680, 0.5), n.setSize(o, i, false);
      const a = [], c = new Scene(), u = this._buildMaterial(o, i), x = new PlaneGeometry(g, _, 240 * e, 240 * e), l = new Mesh(x, u);
      l.rotation.x = -Math.PI / 3.5, l.position.z = -1, a.push(l), c.add(l);
      const v = new OrthographicCamera(0, 0, 0, 0, 0, 0);
    ...
    _buildMaterial(e, o) {
      const i = [
        ...
        u_time: { value: 0 },
        u_color_pressure: { value: new Vector2(this._horizontalPressure, this._verticalPressure) },
        ...
        u_resolution: { value: new Vector2(e, o) },
        u_colors: { value: i },
  ...
  function F(t, e, o) {
    ...
    t instanceof OrthographicCamera ? (t.left = l, t.right = v, t.top = m, t.bottom = p, t.near = w, t.far = b, t.updateProjectionMatrix()) : t instanceof PerspectiveCamera && (t.aspect = e / o, t.updateProjectionMatrix());
  }
  function j() {
    return `
...
`;
  ...
  function G() {
    const t = /* @__PURE__ */ new Date(), e = t.getMinutes(), o = t.getSeconds();
    return e * 60 + o;
  }
  function U(t = 6) {
